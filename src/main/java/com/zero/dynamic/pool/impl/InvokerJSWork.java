 ...
 *
 * @author Zero.
 * <p> Created on 2025/7/8 10:18 </p>
 */
public class InvokerJSWork extends AbstractWorker {
    public InvokerJSWork(String script) {
        super("js", script, null);
    }
